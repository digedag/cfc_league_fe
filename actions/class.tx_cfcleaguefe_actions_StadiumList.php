 ...
 *  Copyright notice
 *
 *  (c) 2010-2018 Rene Nitzsche (rene@system25.com)
 *  All rights reserved
 *
...
class tx_cfcleaguefe_actions_StadiumList extends tx_rnbase_action_BaseIOC
{
    ...
    function handleRequest(&$parameters, &$configurations, &$viewData)
    {
        ...
        tx_rnbase_filter_BaseFilter::handleCharBrowser($configurations, $this->getConfId() . 'stadium.charbrowser', $viewData, $fields, $options, array(
        ...
        tx_rnbase_filter_BaseFilter::handlePageBrowser($configurations, $this->getConfId() . 'stadium.pagebrowser', $viewData, $fields, $options, array(
            'searchcallback' => array(
                $srv,
                'search'
            ),
    ...
    {
        return 'tx_cfcleaguefe_views_StadiumList';
    }
}
