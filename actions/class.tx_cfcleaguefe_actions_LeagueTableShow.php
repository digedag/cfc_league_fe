...
//t3lib_div::debug($TSFE, 'ac_lt', __LINE__, __FILE__);
...
// $GLOBALS['TSFE']->sL('LLL:EXT:sr_feuser_register/pi1/locallang.php:missing_'.$check);
  ...
  function buildTable($parameters,&$configurations, &$league) {
    ...
    $arr = Array(
      'table' => $leagueTable->generateTable($parameters,$configurations, $league),
      'pointsystem' => $leagueTable->cfgPointSystem
    );
    return $arr;
  }
